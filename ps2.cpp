...
void PS2_GPIO_Init()
{
    pinMode(PS2_DI, INPUT);
    pinMode(PS2_DO, OUTPUT);
    pinMode(PS2_CS, OUTPUT);
    pinMode(PS2_SCK, OUTPUT);
}

void PS2_CS_H()
{
	digitalWrite(PS2_CS, 1);
}

void PS2_CS_L()
{
	digitalWrite(PS2_CS, 0);
}

void PS2_SCK_H()
{
	digitalWrite(PS2_SCK, 1);
}

void PS2_SCK_L()
{
	digitalWrite(PS2_SCK, 0);
}

void PS2_DO_H()
{
	digitalWrite(PS2_DO, 1);
}

void PS2_DO_L()
{
	digitalWrite(PS2_DO, 0);
}

uint8_t Read_PS2_DI()
{
	uint8_t di = digitalRead(PS2_DI);
	return di;
}
